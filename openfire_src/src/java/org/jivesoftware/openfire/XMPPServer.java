...
import org.jivesoftware.openfire.mysession.DyrsSessionManagerImpl;
...
//                            ((AdminConsolePlugin) pluginManager.getPlugin("admin")).startup();
    ...
    private void loadModules() {
        ...
        //添加dyrs的权限拦截器
        loadModule(DyrsSessionManagerImpl.class.getName());
...
//            jedis.flushDB();
     ...
     * @return
     */
    public DyrsSessionManagerImpl getDyrsSessionManagerImpl() {
        return (DyrsSessionManagerImpl) modules.get(DyrsSessionManagerImpl.class);
    }
